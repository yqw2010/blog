...
<tr>
<td>13</td>
<td>忽略&rsquo;&gt;&rsquo;后有注释的选择器：selector&gt; /**/ selector{}</td>
<td>IE6</td>
...
<td>!important is evil, don&rsquo;t use it anymore</td>
...
<td>给a添加background, 如果背景透明，使用background:url(&lsquo;任何页面中已经缓存的文件链接&rsquo;)，不推荐background：url(#)[<a href="http://haslayout.net/css/Partial-Click-Bug-v2" target="_blank">官方的解决方法</a>]，因为会增加一下HTTP请求</td>
...
<td>把background:none变成background:url(&lsquo;链接&rsquo;)，链接到本身和图片之外的任何文件</td>
